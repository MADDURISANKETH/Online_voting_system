...
session_start();
if(empty($_POST['lan'])){
$error="<center><h4><font color='#FF0000'>Please select an usn to vote!</h4></center></font>";
include"voter.php";
exit();
}
$lan = $_POST['lan'];
...
$sql1 =mysqli_query($con, 'UPDATE voting_result SET votecount = votecount + 1 WHERE fullname = "'.$_POST['lan'].'"');
